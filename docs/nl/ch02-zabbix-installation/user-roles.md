---
beschrijving: |
    Leer hoe Zabbix gebruikersrollen de frontend en API rechten bepalen. Definieer wat
    gebruikers kunnen doen, terwijl gebruikersgroepen bepalen wat ze kunnen zien.
tags: [beginner]
---
