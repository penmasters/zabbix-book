...
Для создания этого файла нам понадобится команда `htpasswd`. Выполните следующие
команды, чтобы убедиться, что у нас есть эта утилита:

!!! info "Установите утилиту htpasswd"
