...
to the database server. By default, MariaDB listens on port 3306.
...
First, create the Zabbix server database user:
...
Execute the following command to create the database with the owner set to 
`zabbix-srv`:
