---
description: "Cette section du livre Zabbix, intitulée \" Authentification HTTP
\", explique comment sécuriser l'accès au frontend de Zabbix en utilisant les
