...
| Scripts globaux sur le serveur Zabbix                     | Il nous informe que les scripts globaux sont activés ou désactivés dans la configuration du serveur.                                                                                                                     | Les scripts globaux peuvent être utilisés dans le frontend, les actions, ... mais doivent être activés au préalable.                                                                                                                                                                                                                                              |
