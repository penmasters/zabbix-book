...
| ------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Le serveur Zabbix fonctionne                      | Le statut de notre serveur zabbix s'il fonctionne oui ou non et s'il fonctionne sur notre localhost ou sur une autre IP et sur quel port le serveur zabbix est à l'écoute. Si aucun trappeur n'est à l'écoute, le reste de l'information ne peut pas être affiché. | IP et port du serveur Zabbix                                                                                                                                                                                                                                                    |
...
| Version frontale de Zabbix                        | Il s'agit de la version du frontend et elle doit correspondre à ce que vous voyez en bas de votre écran.                                                                                                                                                           | Numéro de version                                                                                                                                                                                                                                                               |
